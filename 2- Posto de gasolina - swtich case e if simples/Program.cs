...
Console.WriteLine($"Digite quantos litros voce deseja abastecer?: ");
...
{
    valor = Math.Round((g * litros), 2);
    desconto = Math.Round((valor / 100 * 4), 2);
...
{
    valor = Math.Round((g * litros), 2);
    desconto = Math.Round((valor / 100 * 6), 2);
    total = Math.Round((valor - desconto), 2);
...
Console.WriteLine($"O valor total do abastecimento ficou em: R$ {valor}");
Console.ResetColor();
Console.ForegroundColor = ConsoleColor.Yellow;
Console.WriteLine($"Você ganhou um desconto de: R$ {desconto}");
Console.ResetColor();
Console.ForegroundColor = ConsoleColor.Green;
Console.WriteLine($"Agora seu valor total ficou em: R$ {total}");
Console.ResetColor();
Console.ForegroundColor = ConsoleColor.Red;
Console.WriteLine($" ---------------Posto estrela do amanhã agradece a preferência!---------------");
Console.ResetColor();
